...
>GET /urls/{id} --> This is to query the scan progress and thus results of a particular file sent via /files and /upload POST endpoints.

>GET /files/{id} --> given a file's hash value, pertains to retrieving the pertinent reports about it.
